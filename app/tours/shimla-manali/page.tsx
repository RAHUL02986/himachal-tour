...
const tourDetails = {
  ...
  description: 'Experience the classic hill stations of Himachal Pradesh with adventure activities, colonial architecture, and stunning mountain vistas.',
  images: [
  ...
  itinerary: [
    {
      ...
      activities: ['Arrival and hotel check-in', 'Visit Mall Road and Ridge', 'Christ Church visit', 'Local shopping and dinner']
    },
    {
      day: 2,
      title: 'Shimla Sightseeing',
      activities: ['Jakhu Temple visit', 'Viceregal Lodge tour', 'Kufri excursion', 'Himalayan Nature Park']
    },
    {
      day: 3,
      title: 'Shimla to Manali',
      activities: ['Check-out and drive to Manali', 'Scenic route via Kullu Valley', 'Hotel check-in in Manali', 'Evening at leisure']
    },
    {
      day: 4,
      title: 'Manali Adventure',
      activities: ['Solang Valley excursion', 'Adventure activities (paragliding/zorbing)', 'Rohtang Pass visit (seasonal)', 'Local market exploration']
    },
    {
      day: 5,
      title: 'Departure',
      activities: ['Hadimba Temple visit', 'Manu Temple exploration', 'Check-out and departure', 'Drop at departure point']
    }
  ],
  included: [
    'Accommodation for 4 nights (2 in Shimla, 2 in Manali)',
...
export default function ShimlaManaliFour() {
  return (
