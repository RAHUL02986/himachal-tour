...
const tourDetails = {
  ...
  description: 'Explore the Parvati Valley with the charming villages of Kasol and Tosh. Perfect for trekkers and backpackers who love riverside walks, Israeli cafes, and Himalayan adventures.',
  images: [
  ...
  itinerary: [
    {
      ...
      activities: [
        'Arrival and hotel/guesthouse check-in',
        'Walk along Parvati River',
        'Evening at Kasol Market & Cafes',
    ...
    },
    {
      ...
      activities: [
        'Visit Chalal Village trek (easy walk)',
        'Explore local cafes (Israeli food)',
        'Riverside relaxation',
        'Bonfire and overnight stay in Kasol'
      ]
    },
    {
      day: 3,
      title: 'Kasol to Tosh',
      activities: [
        'Drive to Tosh village',
        'Trek around Tosh waterfall & nearby trails',
        'Explore local cafes and wooden houses',
    ...
    },
    {
      ...
      activities: [
        ...
        'Return trek/drive back to Kasol',
  ...
  included: [
    'Accommodation for 3 nights (2 in Kasol, 1 in Tosh)',
    'Breakfast and dinner included',
    'Transportation between Kasol and Tosh',
  ...
  excluded: [
    ...
    'Travel to/from Kasol starting point',
    'Tips and gratuities',
...
export default function KasolTosh() {
  return (
