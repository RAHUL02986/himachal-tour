...
const tourDetails = {
  title: 'Kullu Valley Tour Package',
  description:
    'Experience the breathtaking charm of Kullu Valley, known for its apple orchards, pine forests, riverside beauty, and rich Himachali culture. Perfect for adventure lovers, families, and couples seeking a blend of peace and thrill.',
  images: [
  ...
  itinerary: [
    {
      ...
      activities: [
        ...
        'Leisure walk along Beas River',
        'Explore Kullu market & local handicrafts',
        'Overnight stay in Kullu'
      ]
    },
    {
      day: 2,
      ...
      activities: [
        ...
        'Explore Naggar Castle & Roerich Art Gallery',
        'Scenic drive through apple orchards & pine forests',
        'Overnight stay in Kullu'
      ]
    },
    {
      day: 3,
      title: 'Adventure in Kullu Valley',
      activities: [
        'Rafting experience in Beas River',
        'Visit Great Himalayan National Park',
        'Photography & nature walks',
        'Bonfire & overnight stay in Kullu'
      ]
    },
    {
      day: 4,
  ...
  included: [
    'Accommodation for 3 nights in Kullu',
    'Breakfast and dinner included',
    'Sightseeing of Kullu Valley & nearby attractions',
    'Adventure activity (rafting included)',
  ...
  excluded: [
    ...
    'Tips and gratuities',
    'Optional activities (paragliding, horse riding, etc.)',
    'Camera charges at monuments'
  ]
};

export default function KulluValley() {
  return (
