...
import { ArrowLeft, Clock, Users, Star, Check, Phone } from 'lucide-react';
...
const tourDetails = {
  ...
  description:
    'Discover the colonial charm of Dalhousie and the scenic beauty of Khajjiar, often called the Mini Switzerland of India. Perfect for couples, families, and nature lovers seeking peace, meadows, and panoramic Himalayan views.',
  images: [
  ...
  itinerary: [
    {
      ...
      activities: [
        ...
        'Evening stroll at Mall Road & Gandhi Chowk',
        'Local shopping and café hopping',
    ...
    },
    {
      ...
      activities: [
        'Visit St. John’s Church & colonial landmarks',
        'Excursion to Subhash Baoli & Panchpula',
        'Scenic drive through pine & deodar forests',
        'Overnight stay in Dalhousie'
      ]
    },
    {
      ...
      activities: [
        'Drive to Khajjiar, Mini Switzerland of India',
        'Visit Khajjiar Lake & enjoy meadow activities',
        'Photography & nature walks',
        'Return to Dalhousie for overnight stay'
      ]
    },
    {
      day: 4,
      ...
      activities: [
        ...
        'Transfer to nearest airport/railway station',
        'Tour ends with sweet memories'
      ]
    }
  ],
  included: [
    'Accommodation for 3 nights in Dalhousie',
    'Breakfast and dinner included',
    'Sightseeing of Dalhousie & Khajjiar',
    'Transportation for all transfers & excursions',
  ...
  excluded: [
    ...
    'Tips and gratuities',
    'Adventure activities (paragliding, horse riding, etc.)',
    'Camera charges at monuments'
  ]
};

export default function DalhousieKhajjiar() {
  return (
              ...
              <Card className="overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-blue-600 to-green-600 text-white">
                  <div className="flex justify-between items-start">
                    ...
                    <Badge className="bg-green-500 text-white">23% OFF</Badge>
                  </div>
